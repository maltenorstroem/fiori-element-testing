...
export class Styling {
  static get theme() {
    ...
    return css`
      ...
      /**
* Copyright (c) 2012-2019 SAP SE. All Rights Reserved Licensed under the Apache License, Version 2.0 - see LICENSE.txt.
*
* Theming Engine 1.51.0
* data:{"Path": "Base.baseLib.sap_fiori_3_light_dark.css_variables", "PathPattern": "/%frameworkId%/%libId%/%themeId%/%fileId%.css", "Extends": [], "Tags": ["Fiori_3"], "FallbackThemeId": "sap_fiori_3", "Version": { "Build":"11.1.19.20200407101940", "Source": "11.1.19", "Engine": "1.51.0"}}
*/

      .sapThemeMetaData-Base-baseLib{background-image: url('data:text/plain;utf-8,{"Path": "Base.baseLib.sap_fiori_3_light_dark.css_variables", "PathPattern": "/%frameworkId%/%libId%/%themeId%/%fileId%.css", "Extends": [], "Tags": ["Fiori_3"], "FallbackThemeId": "sap_fiori_3", "Version": { "Build":"11.1.19.20200407101940", "Source": "11.1.19", "Engine": "1.51.0"}}');}
        ...
        --sapIndicationColor_3_Hover_Background: #da6c0b;
        --sapIndicationColor_3_Active_Background: #cc650b;
      ...
      /*SCOPING Base.baseLib.sap_fiori_3_dark.css_variables with "@media (prefers-color-scheme: dark)"*/@media (prefers-color-scheme: dark){:root {
        ...
        --sapInformativeTextColor: #c0e0fa;
        ...
        --sapIndicationColor_8_TextColor: #29313a;
        --sapElement_LineHeight: 2.75rem;
        --sapElement_Height: 2.25rem;
        --sapElement_BorderWidth: .0625rem;
        --sapElement_BorderCornerRadius: .25rem;
        ...
        --sapContent_HeaderShadow: 0 0 0.25rem 0 rgba(0,0,0,0.8), inset 0 -0.0625rem 0 0 #3a4552;
        ...
        --sapContent_BadgeTextColor: #fff;
        --sapContent_Placeholderloading_Background: #424f5e;
        --sapContent_Placeholderloading_Gradient: linear-gradient(to right, #424f5e 0%, #424f5e 35%, #4d5c6d 50%, #424f5e 65%, #424f5e 100%);
        ...
        --sapShell_Selected_Hover_Background: #23303e;
        --sapShell_Favicon: none;
        --sapShell_Navigation_Background: #29313a;
        --sapShell_Navigation_SelectedColor: #91c8f6;
        --sapShell_Navigation_Selected_TextColor: #91c8f6;
        --sapShell_Navigation_TextColor: #fafafa;
        --sapShell_Shadow: 0 0 0.5rem 0 rgba(0,0,0,0.8), inset 0 -0.0625rem 0 0 rgba(255,255,255,0.2);
        --sapButton_BorderWidth: .0625rem;
        --sapButton_BorderCornerRadius: .25rem;
        ...
        --sapButton_Emphasized_Hover_TextColor: #29313a;
        ...
        --sapList_AlternatingBackground: #2d3640;
